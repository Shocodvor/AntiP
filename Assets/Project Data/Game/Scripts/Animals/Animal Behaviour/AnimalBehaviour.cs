...
namespace Watermelon
{
    ...
    public class AnimalBehaviour : MonoBehaviour
    {
        ...
        public static readonly int STOP_HASH = Animator.StringToHash("Stop");
        ...
        public void StopMovement()
        {
             ...
             Debug.Log ("StopFFFFUCKINMovement");
            ...
            public void SetOnTable()
        {
           ...
           // if (!isMoving)
            ...
            animalAnimator.Play ("Stop");
             animalAnimator.SetBool(STOP_HASH, true);
        }
